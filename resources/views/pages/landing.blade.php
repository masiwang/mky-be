...
<div class="container">
  <div class="row">
    ...
    <div class="col-12 col-xl-4">
      <img src="/images/makarya-farmer.png" alt="" style="width: 100%">
    </div>
  </div>
</div>
<div style="height: 5rem"></div>
<div class="container">
  ...
  <div class="row">
    <div class="col-12 col-md-4 text-center">
      <img class="mb-4" src="/images/makarya-vector-02-480x295.png" alt="" width="100%">
    ...
    <div class="col-12 col-md-4 text-center">
      <img class="mb-4" src="/images/makarya-vector-03-480x295.png" alt="" width="100%">
      <h3 class="h3">Kirim Modal Usaha</h3>
      <p class="text-secondary">Transfer uang yang akan diberikan pada usaha yang dipilih</p>
    </div>
    <div class="col-12 col-md-4 text-center">
      <img class="mb-4" src="/images/makarya-vector-04-480x295.png" alt="" width="100%">
