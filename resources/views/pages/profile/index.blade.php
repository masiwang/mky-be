      ...
      <div id="profileIndexContainer" class="row bg-white shadow-sm">
        <div class="col-xl-3 col-12 p-4 border-right">
          <div class="container">
            ...
            @else
              <div style="width: 100%; height: 200px; background-color: grey" class="d-flex justify-content-center align-items-center">
                <p class="mb-0">
            ...
            @endif
            <a type="button" class="btn btn-primary btn-sm center mt-2 w-100" data-toggle="modal" data-target="#exampleModal-profile">
