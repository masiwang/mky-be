            ...
            <div class="col-12 p-2">
                <header class="row border-bottom">
                    <div class="col-12 col-md-6">
                        <h4 class="text-uppercase">Wishlist</span></h4>
                    </div>
                </header>
            </div>
        </div>
        <div class="mt-3" id="wishlist-product-container">
            <div class="row">
...
<script>
    ...
    var wishlistProductGet = new Vue({
        el: '#wishlist-product-container',
        data(){
            return{
                loading: true,
                products: [],
        ...
        methods:{
            load: function(){
                axios.get('http://127.0.0.1:8000/v1/wishlist', {
                    params: {
