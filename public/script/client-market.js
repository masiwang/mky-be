                ...
                `<div class="col-6 col-md-2 p-2">
                        <div class="card card-product h-100 shadow-sm">
                            ...
                            <div class="card-body p-2 d-flex flex-column">
                                ...
                                <hr>
                                <div class="mb-1 d-flex justify-content-between">
                                        <a data-product="${e.slug}" data-like="${e.wishlist_id}" class="btn btn-white text-danger w-100 btn-sm btn-action-like">
...
document.querySelector('.btn-action-like').addEventListener('click', function(){
    console.log(1);
})